...
// Состояние 2: Доступ разрешен (показываем правила использования)
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center py-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-10 max-w-xl w-full mx-4 transform transition-all my-auto max-h-[85vh] overflow-y-auto">
        <h2 className="text-xl sm:text-3xl font-black uppercase tracking-wider text-gray-900 mb-4 sm:mb-6 text-center">ПРАВИЛА ИСПОЛЬЗОВАНИЯ</h2>
        ...
        <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-700 leading-relaxed mb-6 sm:mb-8">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>В целях оптимизации нагрузки установлен лимит генераций (3 генерации на пользователя). Ваш лимит строго привязан к вашему аккаунту на портале.</li>
          </ul>
          <p className="text-[#b91c1c] font-semibold mt-4">Хороших Вам генераций!</p>
        </div>
